...
const Newsletter = () => {
    return (
        <div className="bg-white d-flex flex-column align-items-center container my-5 p-5 col-md-9 m-auto">
            ...
            <form action="" className="d-flex gap-md-2 flex-column flex-md-row mt-2 justify-content-md-between w-100">
                ...
                <div className="col-md-4  d-flex justify-content-center">
                    <button type="submit" className="border-0 color2 text-white w-100">
                        ¡ME APUNTO!
                    </button>
                </div>
            </form>
