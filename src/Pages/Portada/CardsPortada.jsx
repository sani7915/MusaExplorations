...
const [t] = useTranslation("global")
    ...
    return (
        cardCategory.map(card => {
            return (
                <div key={card.p1} className={`${card.bg} d-flex flex-column justify-content-center position-relative col-11 col-md-4 text-white text-center fs-3  card_portada-heigth`}>
                    ...
                    <div className="d-flex justify-content-start align-items-end arrow_card_portada ">
                        <Link to={card.url} className='text-white bg-arrow'>
