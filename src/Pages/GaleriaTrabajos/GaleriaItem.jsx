...
const GaleriaItem = ({ imagen, nombre, categoria, popUp , id}) => {
    const [hover, setHover] = useState('d-none');

    return (
        <div className="gallery-card " onMouseOver={() => setHover('')} onMouseOut={() => setHover('d-none')}>
            <div>
                <img src={require('../../images/laminas/' + imagen + '.jpg')} id={id} alt={nombre} onClick={() => popUp(require('../../images/laminas/' + imagen + '.jpg'), nombre, categoria)} />
            </div>
