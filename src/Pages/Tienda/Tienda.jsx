    ...
    <div className='d-flex flex-column align-items-center m-auto col-11 col-lg-10 col-xl-8 col-xxl-7'>
      ...
      <div className='d-flex flex-column flex-md-row  justify-content-between'>
        <div className='d-flex flex-column align-items-center card-tienda mb-3'>
          ...
          <a href="https://www.etsy.com/shop/musadeacuarela" target={'_blank'} rel="noreferrer" className='nav-link text-center'>
        ...
        <div className='d-flex flex-column align-items-center card-tienda'>
          ...
          <a href="https://www.spoonflower.com/profiles/musadeacuarela?sub_action=designs" target={'_blank'} rel="noreferrer" className='nav-link text-center'>
            <p className='mt-3 mb-1'>
